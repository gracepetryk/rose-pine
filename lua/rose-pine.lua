...
local function set_highlights()
	...
	local default_highlights = {
		...
		CursorColumn = { bg = groups.panell },
		-- CursorIM = {},
		CursorLine = { bg = groups.panel },
		CursorLineNr = { fg = palette.text, bg = groups.panel, bold = styles.bold },
		CursorLineSign = { fg = palette.text, bold = styles.bold },
		CursorLineFold = { fg = palette.muted, bg=groups.panel },
		-- DarkenedPanel = { },
		-- DarkenedStatusline = {},
		...
		Pmenu = { fg = palette.subtle, bg = palette.float },
		PmenuExtra = { fg = palette.muted, bg = palette.float },
		PmenuExtraSel = { fg = palette.subtle, bg = palette.overlay },
		PmenuKind = { fg = palette.foam, bg = palette.float },
		PmenuKindSel = { fg = palette.subtle, bg = palette.overlay },
		PmenuSbar = { bg = palette.float },
		...
		["@lsp.type.typeParameter.python"] = { link = "@variable.builtin" },  -- self, cls in ty
		...
		RenderMarkdownCodeInline = { fg = palette.text, bg = palette.highlight_low, bold=true },
